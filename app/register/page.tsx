          ...
          {[1, 2, 3, 4].map((i) => (
            <div
              ...
              style={{
                ...
                height: 3,
                borderRadius: 2,
                background: i <= score ? colors[score] : "#e0f2f1",
              }}
            />
          ))}
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.95rem" }}>
            <div>
              ...
              <input
                style={{
                  ...inp,
                  borderColor: errors.name ? "#dc2626" : "#e0f2f1",
                }}
            ...
            <div>
              ...
              >
                Mobile Number <span style={{ color: "#0d9488" }}>*</span>
              </label>
              <div style={{ position: "relative" }}>
                ...
                <input
                  style={{
                    ...inp,
                    paddingLeft: 46,
                    borderColor: errors.phone ? "#dc2626" : "#e0f2f1",
                  }}
            ...
            <div>
              ...
              >
                Confirm Password <span style={{ color: "#0d9488" }}>*</span>
              </label>
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    ...inp,
                    paddingRight: 44,
                    borderColor: errors.confirmPassword ? "#dc2626" : "#e0f2f1",
                  }}
            ...
            <div>
              ...
              >
                ...
                <span style={{ fontSize: "0.82rem", color: "#4b7b7b", lineHeight: 1.6 }}>
                  I agree to{" "}
                  <a href="#" style={{ color: "#0d9488", fontWeight: 600 }}>
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" style={{ color: "#0d9488", fontWeight: 600 }}>
