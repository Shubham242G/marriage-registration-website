...
export default function ContactPage() {
  ...
  // Generic theme since this page no longer depends on religion
  const theme = {
    accentTeal: "#0d9488",
    lightTeal: "#f0fdfa",
    borderColor: "#ccfbf1",
  ...
  const Label = ({
    ...
    >
      {text}{" "}
      {required && (
        <span style={{ color: theme.accentTeal }}>
          *
        </span>
      )}
    </label>
      ...
      >
        ...
        >
          ...
          >
            ...
            and guide you through every step of your marriage
            registration.
          </p>
        </motion.div>
      </section>
        ...
        <AnimatePresence mode="wait">
          {submitted ? (
            ...
            >
              ...
              >
                Thank you,{" "}
                <strong>{form.name}</strong>. We've received
                your query and a team member will reach out to
                you via{" "}
                <strong>{form.preferredContact}</strong>{" "}
                within{" "}
            ...
            <motion.div
              ...
              style={{
                ...
                padding: "2.5rem",
                boxShadow:
                  "0 4px 24px rgba(13,148,136,0.06)",
              }}
            >
              <h2
                style={{
              ...
              >
                We typically respond within 24 working
                hours. Your information is kept strictly
                confidential.
              </p>
            </motion.div>
          )}
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "1.75rem",
              boxShadow:
                "0 2px 12px rgba(13,148,136,0.05)",
            }}
          >
            <h3
              style={{
          ...
          <div
            style={{
              background:
                "linear-gradient(135deg, #0f4c4c, #0d9488)",
              borderRadius: 14,
              padding: "1.75rem",
              textAlign: "center",
            }}
